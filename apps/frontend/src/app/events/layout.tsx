...
/**
 * Event Layout - Shared layout for event pages
 * Includes header and sidebar navigation
 * Skips layout for create page (which handles its own layout)
 */
export default function EventLayout({
  ...
  // Skip layout for create page and event detail pages - they handle their own layout
  if (
