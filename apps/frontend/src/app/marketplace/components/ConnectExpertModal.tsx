...
export default function ConnectExpertModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full mx-4 relative z-[101]">
        {/* Modal Header */}
        ...
        <div className="px-6 py-5">
          ...
          <div className="bg-[#f5f5f0] rounded-lg p-4 mb-5 border border-gray-200">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className="flex items-start gap-2">
                  <span className="text-gray-900 shrink-0 mt-0.5 text-lg leading-none">
                    •
                  </span>
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <button
              ...
              disabled={!canAfford}
              className={`flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg font-medium transition-colors whitespace-nowrap ${
                canAfford
